...
| Content model | Campaign, rooms, doors, actors, objects, actions, animations, speed profiles, combinations, triggers | synthetic campaign fixture and generic-before-level overlay test |
| Navigation | Integer room graph, blocked doors, deterministic lowest-cost routing, actor-specific door hotspots | navigation test with tie-breaking and door-anchor fixtures |
