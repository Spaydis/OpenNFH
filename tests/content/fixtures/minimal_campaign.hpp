...
<leveldata>
  ...
  <set name="set03" state="locked"/>
            ...
            {"generic/objects.xml", R"(<object name="shared" gfx="shared"/><inventar name="pin"><image name="std" gfx="gui/inv/i_pin_norm.tga"/></inventar><actor name="woody" gfx="woody"><speed name="mg0" speed="3" start="0" noise="0"/></actor>)"},
            ...
            {"level_mail/level.xml", R"(<level name="level01" size="10/10" angrytime="1"><room name="room" offset="0/0" path1="0/0" path2="10/0"><neighbor name="other" doorcost="7" doorin="room/door" doorout="other/door"/></room></level>)"},
